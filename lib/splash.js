...
export default function splash({ name, org, logo, active, total, channels, iframe, codeofconduct }){
  let div = dom('.splash',
    !iframe && dom('.logos',
      logo && dom('.logo.org'),
      dom('.logo.slack')
    ...
    dom('form',
      ...
      dom('input.form-item type=email placeholder=you@yourdomain.com '
        + (!iframe ? 'autofocus' : '')),
      codeofconduct && dom('label',
        dom('input.form-item type=checkbox'),
        'I agree to abide by the ',
        dom(`a href=${codeofconduct}`,
          'code of conduct')),
