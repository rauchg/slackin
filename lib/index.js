  ...
  app.get('/', (req, res) => {
    ...
    let page = dom('html',
      dom('head',
        ...
        dom('script async src=https://www.googletagmanager.com/gtag/js?id=UA-47563775-2'),
        dom('script',
          "window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'UA-47563775-2');"
        )
      ),
