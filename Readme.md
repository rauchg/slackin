...
The following information should be submitted to speed up the issue review process:
...
### Software Version
Please include the version of the editor you are submitting this issue for
